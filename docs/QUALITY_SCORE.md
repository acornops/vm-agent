...
| Reliability | 4/5 | Authenticated generations, bounded executor, transactional install recovery, backpressure, jittered reconnects, enforced full-suite coverage, package smoke, and required live Ubuntu and Rocky Linux 9 systemd gates | Record green immutable-release gates and complete the staging power-cycle recovery canary before rollout |
